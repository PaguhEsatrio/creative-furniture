  ...
  -->
    <header class="header" data-header>
        <div class="container">
            ...
            <a href="#">
                <h1 class="logo">CraFurn ID</h1>
            </a>

            <nav class="navbar" data-navbar>

                <div class="navbar-top">
                    <a href="#" class="logo">CraFurn ID</a>
            ...
            <section class="hero" id="home">
                <div class="container">
                    ...
                    <figure class="hero-banner">
                        <img src="images/hero-banner.png" width="694" height="529" loading="lazy" alt="hero-banner" class="w-100 banner-animation">
                    </figure>
            ...
            <section class="section features" id="features">
                <div class="container">
                    ...
                    <figure class="features-banner">
                        <img src="images/feautres-banner.png" width="369" height="318" loading="lazy" alt="Features Banner" class="w-100 banner-animation">
                    </figure>
                    ...
                    <ul class="blog-list">
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="banner">
                                    <a href="#">
                                        <img src="images/blog-1.jpg" width="750" height="350" loading="lazy" alt="Vestibulum massa arcu, consectetu pellentesque scelerisque." class="img-cover">
                                    </a>
                                </figure>
